<x-app-layout>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-car mr-2 text-blue-600"></i>Nuevo Vehículo
        </h1>
    ...
    <form action="{{ route('vehiculos.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="anio" value="{{ old('anio') }}" min="1900" max="{{ date('Y') + 1 }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="notas" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notas') }}</textarea>
